...
module ViewModels {
	...
	export class ApplicationUser extends BaseViewModel<ApplicationUser>
    {
        ...
        protected viewUrlBase = "ApplicationUser";
        ...
        constructor(newItem?: any, parent?: any){
            ...
            self.editUrl = ko.computed(function() {
                return self.areaUrl + self.viewUrlBase + "/CreateEdit?id=" + self.applicationUserId();
            });
