...
namespace CoalesceStarter.Web.Api
{
    ...
    public partial class ApplicationUserController 
         : LocalBaseApiController<CoalesceStarter.Data.Models.ApplicationUser, ApplicationUserDtoGen> 
    {
        ...
        [HttpGet("list")]
        [Authorize]
        public virtual async Task<GenericListResult<CoalesceStarter.Data.Models.ApplicationUser, ApplicationUserDtoGen>> List(
            ...
            string applicationUserId = null,string name = null)
        {
            ...
            return new GenericListResult<CoalesceStarter.Data.Models.ApplicationUser, ApplicationUserDtoGen>(listResult);
        }
        ...
        [Authorize]
        protected override IQueryable<CoalesceStarter.Data.Models.ApplicationUser> GetListDataSource(ListParameters parameters)
        {
